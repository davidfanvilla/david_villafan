...
function draw() {
  ...
  velocity *= 1.00; // Reducir la velocidad para inercia
...
function touchStarted() {
  // Verificar si el toque fue en un enlace
  let clickedElement = document.elementFromPoint(mouseX, mouseY);
  if (clickedElement && (clickedElement.tagName === 'A' || clickedElement.parentElement.tagName === 'A' || clickedElement.tagName === 'IMG')) {
      return true; // Permitir el comportamiento predeterminado para enlaces
  }
